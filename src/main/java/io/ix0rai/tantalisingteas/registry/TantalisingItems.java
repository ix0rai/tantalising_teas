...
public class TantalisingItems {
    ...
    public static final Item TEA_BOTTLE = new DrinkableTeaItem(new Item.Settings().food(new FoodComponent.Builder().saturationModifier(3.0f).hunger(1).alwaysEdible().build()));
