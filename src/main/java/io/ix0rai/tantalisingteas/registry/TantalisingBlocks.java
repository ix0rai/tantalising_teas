...
import io.ix0rai.tantalisingteas.blocks.CauldronBlockEntity;
...
public class TantalisingBlocks {
    ...
    public static final BlockEntityType<CauldronBlockEntity> TEA_CAULDRON_ENTITY = FabricBlockEntityTypeBuilder.create(CauldronBlockEntity::new, TEA_CAULDRON).build(null);
