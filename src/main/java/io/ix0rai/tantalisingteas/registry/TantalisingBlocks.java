...
public class TantalisingBlocks {
    public static final BoilingCauldron TEA_CAULDRON = new BoilingCauldron(AbstractBlock.Settings.copy(Blocks.CAULDRON), LeveledCauldronBlock.RAIN_PREDICATE, BoilingCauldron.BEHAVIOUR);
